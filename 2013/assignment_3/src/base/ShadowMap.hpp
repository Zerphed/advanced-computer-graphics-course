...
protected:
	...
	Vec2f	m_size;		// physical size of the emitting surface (ignored in the basic instant radiosity implementation)
	Vec3f	m_E;		// diffuse emission
	float	m_fov;		// field of view in _degrees_
